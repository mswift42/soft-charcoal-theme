...
(custom-theme-set-faces
  'soft-charcoal 
        ...
        '(region ((t (:background "#" :foreground "#faf4c6"))))
	...
	'(cursor ((t (:background "#626262"))))
        ...
        '(modeline-buffer-id ((t (:bold t :foreground "#5d90cd" :background "#191919"))))
        '(minibuffer-prompt ((t (:bold t :foreground "#708090"))))
        '(default-italic ((t (:italic t))))
	'(font-lock-comment-face ((t (:foreground "#808080"))))
	'(font-lock-negation-char-face ((t (:foreground "#f03f3f"))))
	'(font-lock-reference-face ((t (:foreground "#d08689"))))
	'(font-lock-constant-face ((t (:foreground "#d08689"))))
        '(font-lock-doc-face ((t (:foreground "#7d949b"))))
        '(font-lock-function-name-face ((t (:foreground "#e3e3e3"))))
